...
{:else}
  <QuickPanelScreen
    ...
    contextMenuProject={state.contextMenuProject}
    ...
    onOpenContextMenu={controller.openProjectContextMenu}
    onCloseContextMenu={controller.closeProjectContextMenu}
    onPickColor={controller.pickProjectColor}
    onPickGroup={controller.pickProjectGroup}
    onRequestNewGroup={controller.requestNewProjectGroup}
    ...
    onOpenGithubIssues={controller.openGithubIssues}
