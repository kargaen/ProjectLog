...
| 2026-07-29 | dependency-change run | `description/01` | Added the frontend Tauri dialog binding so QuickPanel destructive resets use the native dialog facility already used by the tray. |
